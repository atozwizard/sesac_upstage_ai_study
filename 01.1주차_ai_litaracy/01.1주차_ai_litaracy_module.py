...
def get_summary() -> WeekSummary:
    ...
    s.missions = []
    s.scripts = []
    s.projects = ['README_TECHSTACK.md', 'README_TECHSTACK_DRAFT.md']
    s.notebooks = ['extracted_content\\advanced_missions_extracted.txt', 'extracted_content\\basic_missions_extracted.txt', 'extracted_content\\extracted_content.json', 'extracted_content\\lectures_extracted.txt']
    s.tech_stack = []
    s.learning_summary = ['학습', '평가', '결과', '실행', '목표', '코드', '과제', '실습']
    return s
