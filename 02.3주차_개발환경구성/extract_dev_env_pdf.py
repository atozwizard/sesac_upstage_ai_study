"""
Development Environment Course (03주차) PDF 추출 및 코드화 스크립트
"""
...
# 폴더 경로
base_path = Path(r"d:\01. study\01.sesac_upstage_ai\03.3주차_개발환경구성")

# 추출할 폴더들
folders = {
    "lectures": base_path / "01.강의자료",
    "daily_missions": base_path / "02.daily mission",
    "advanced_missions": base_path / "03.advanced mission"
}
